...
export const resumeEn = {
  ...
  uni: {
    ...
    date: '2018-2022',
    desc:
      "I'm in the 6th semester, in October I will be in the 7th. My specialization is",
    bold: ' information systems engineering',
  ...
  tal: {
    ...
    date: '2015-2016',
    desc: 'Polish-German exchange. Extended subjects Computer Science.',
  },
  sec: {
    name: 'Secondary school in Gryfino',
    date: '2014-2015, 2016-2018',
  },
  work: {
...
export const resumePl = {
  ...
  lang: {
    name: 'języki obce',
    desc: 'Polski (native) - Angielski (b2) - Niemiecki (b2)',
  },
  skills: {
    name: 'umiejętności',
